...
export declare type PartType = 'pageSize' | 'total' | 'current' | 'page' | 'jumper';
...
export declare type PaginationPropsType = PaginationBaseType & Omit<JSX.IntrinsicElements['ul'], 'onChange'>;
