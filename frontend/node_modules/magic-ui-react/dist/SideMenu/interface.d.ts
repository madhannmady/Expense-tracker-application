...
export declare type ActiveKeyType = Key;
export declare type MenuTreeItemType<T = SidePropsType> = Omit<T, 'key' | 'index' | 'borders'> & {
...
export declare type SidePropsType = {
    /**
     * 图标
     */
    icon?: string;
...
export declare type SideMenuHandleType = {
...
export declare type SideMenuItemPropsType = SidePropsType & Omit<JSX.IntrinsicElements['div'], 'key' | 'title' | 'children'>;
export declare type SideMenuItemSubPropsType = PropsWithChildren<SidePropsType>;
export declare type SideMenuComtextType = {
    /**
     * 选中的menuIiem
     */
...
export declare type SideMenuPropsType = PropsWithChildren<SideMenuBaseType>;
