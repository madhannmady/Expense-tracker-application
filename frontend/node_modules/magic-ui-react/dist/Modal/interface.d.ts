...
export declare type ModalHandle = {
    open: () => void;
    close: () => void;
    visible: boolean;
};
export declare type ModalPropsType = PropsWithChildren<ModalBaseType> & Pick<JSX.IntrinsicElements['div'], 'className' | 'style'>;
export declare type ModalItemProp = Omit<ModalPropsType, 'visible' | 'mountOnEnter' | 'unmountOnExit'>;
