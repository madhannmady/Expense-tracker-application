...
export declare type RadioPropsType = RadioBaseInterFace & Pick<JSX.IntrinsicElements['input'], 'className' | 'style' | 'defaultChecked' | 'name'>;
...
export declare type RadioGroupContextType = {
    name: string;
