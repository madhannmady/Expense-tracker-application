...
export declare type DrawerPropsType = PropsWithChildren<DrawerBaseType> & Pick<JSX.IntrinsicElements['div'], 'className' | 'style'>;
export declare type DrawerItemProp = Omit<DrawerPropsType, 'visible' | 'mountOnEnter' | 'unmountOnExit'>;
...
export declare type DrawerHandle = {
    open: () => void;
    close: () => void;
    visible: boolean;
};
